 ...
 * Description: Mi plugin personalizado para agregar widgets a Elementor
 * Version: 1.0
...
function my_widgets_register_scripts(){
    ...
    wp_register_style("pokeapi-style", plugins_url("assets/styles/css/pokeapi.css", __FILE__), [], "1.0.0", "all");
